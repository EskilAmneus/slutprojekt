...
wall = "Väggplacering är en nyckelpunkt för att utforma en välförsvarad by. Murar är den huvudsakliga befästningen för försvar och kan motstå en hel del skada från attackerande fiender. Effektiviteten hos väggar sänks dock avsevärt om de inte är konstruerade för att helt omsluta de strukturer som de är designade för att skydda. Eventuella luckor i fortsättningen av murstrukturen kommer att göra den oanvändbar, eftersom fiendens trupper helt enkelt kommer att gå genom det trasiga området."
mortar = "Mortars är spelarens lätta stänkförsvar och är det första olåsta försvaret som kan göra skada på området. Närhelst en fiende kommer inom räckhåll, spränger den ut ett explosivt granat som skadar området. Från och med nivå 8, som är vid stadshus 10, kan byggmästaren i byggmästarbasen rusta upp en enda mortar för att få den att likna en multimortar. Den växlade Mortaren skjuter skurar på tre skott, om än med minskad skada, och den skjuter direkt utan att tveka först som vanliga Mortars. Din Multi Mortar måste vara nivå 8, vilket är på Builder Hall 8, eller högre för att växla upp din Mortar. Mortlar skjuter långdistansexplosiva granater var 5:e sekund som orsakar förödande stänkskador på varje markenhet inom en liten radie från islagspunkten. Deras stänkskador, i kombination med deras långa räckvidd, gör dem till dödliga vapen mot stora grupper av svagare fiender som barbarer, bågskyttar eller troll. Flera murbruk kan sopa bort jättar och trollkarlar."
airDefence = "Luftförsvaret är ett kraftfullt torn, upplåst på Town Hall level 4, som uteslutande riktar sig mot flygfiender med mycket hög DPS, bra räckvidd och anständiga träffpunkter. Luftförsvar kan bara rikta och skjuta en lufttrupp åt gången. Det kan inte skada markbaserade enheter eller störa dem på något annat sätt än att potentiellt distrahera dem från att attackera ett mer värdefullt mål (t.ex. Rådhuset)."
wizardTower = "Trollkarlstornet är en försvarsbyggnad som ser ut som ett spiralformigt, konformat stentorn, sedan en kristallliknande sten som har en trollkarl på toppen av sig. Den kan orsaka kraftiga stänkskador på både mark- och luftenheter, även om den är begränsad till en relativt kort räckvidd. Trollkarlens torn, liksom mortarn, utmärker sig på att meja ner hela grupper av trupper. Men till skillnad från Mortar har den en relativt anständig skada per sekund (gör den mer effektiv mot högre hälsotrupper som jättar), och den kommer att rikta in sig på lufttrupper förutom marktrupper. Till skillnad från Mortaren har Trollkarlstornet ingen blind fläck. Även om de mystiska sprängningarna från Trollkarlstornet gör mindre skada per skott än morteln, kompenserar den för detta genom att ha en mycket högre eldhastighet. Detta gör Trollkarlstornet till ett utmärkt val för att försvara andra strukturer genom att spränga trupper som kommer för nära. Trollkarlen kan rikta in sig på både mark- och lufttrupper men kan bara skada antingen marken eller luften med varje skott (inte båda). Till exempel, om ett trollkarlstorn riktar sig mot en jätte med några ballonger på toppen, kommer bara jätten att skadas, och vice versa."
airSweeper = "Luftblåsaren är ett försvar, upplåst på Town Hall level 6, som skjuter luftstötar mot lufttrupper. Även om den inte skadar, trycker den tillbaka lufttrupper, vilket ger andra försvar mer tid att ta ner dessa trupper och hindrar deras avancemang. Eftersom luftblåsaren saknar skador ökar uppgraderingen av luftblåsaren istället avståndet den blåser motståndaren. Det kan inte störa marktrupper på något annat sätt än att potentiellt distrahera dem från att attackera ett mer värdefullt mål (t.ex. rådhuset). Som beskrivningen antyder kan luftblåsaren bara vara vänd mot en enda allmän riktning, även om dess luftskurar (som täcker en mindre vinkel) kan vara var som helst inom denna riktning. På grund av detta kan den roteras 45 grader åt gången och har därför 8 riktningsinställningar."
hiddenTesla = "Gömda teslan är en defensiv byggnad med en twist: liknande en fjäderfälla eller bomb, förblir den dold och dyker upp när en mark- eller luftenhet kommer nära, eller när 51 % av basen förstörs. Men till skillnad från en fälla behöver den inte återupprustas efter att ha utplacerats. Gömda teslan låses upp på Town Hall level 7. Liksom fällor är Gömda teslan endast synliga för spelaren och deras klankamrater. En Gömda teslan har en räckvidd med sju brickor men en triggerradie med sex brickor där den bara dyker upp om en trupp kommer nära den eller om fienden har förstört minst 51 % av basen. Gömda teslan är inte fällor. Deras estetik och mekanik lurar vissa att tro att de är fällor, men de är faktiskt defensiva byggnader som Archer Towers. Den dolda Teslan kan få trupper uppe på den om den är belägen inom en 3x3 (eller större) region som inte innehåller byggnader eller murar. Om du placerar en trupp i spawnhålet kommer den gömda teslan att dyka upp och börja attackera."
bombTower = "Bombtornet är en försvarsbyggnad, upplåst på Stadshusnivå 8, som kastar bomber mot marktrupper och orsakar stänkskador på samma sätt som trolkarlstornet. Men till skillnad från trolkarlstornet kan det inte attackera luftförband. När dess hälsa är reducerad till noll kommer bomben under tornet att fyllas och exploderar 1 sekund efteråt, vilket ger stänkskador på alla markenheter inom 2,75 brickor från den, liknande en jättebomb."
Xbow = "X-Bow är ett en-måls, snabbt skjutande torn som är upplåst på Town Hall nivå 9. X-Bow måste laddas för att fungera. Laddning är gratis och sker automatiskt efter att du loggat in i spelet, men om det skjuter tillräckligt många skott utan att laddas om kommer det så småningom att ta slut på ammunition och kommer inte att skjuta. Det tar 3 minuter och 12 sekunder för en X-Bow att lossa all sin ammunition. Det kan konfigureras till två lägen - Ground Mode, som kan rikta in sig på marktrupper vid ett intervall på 14 brickor, eller Ground and Air, som kan rikta in sig på både mark- och luftenheter med ett reducerat avstånd på 11,5 brickor."
infernoTower = "Inferno Tower är en defensiv byggnad upplåst på Town Hall nivå 10 som skjuter en ström av lågor som brinner genom även den tjockaste rustningen. Den kan ställas in på en-mål eller multi-mål. I singelmålsläge orsakar Inferno Tower progressiv skada på ett singelmål. Ju längre tornet förblir fokuserat på samma mål, desto mer skada orsakar det. Dess skada är låg när den nyligen har låst sig vid en trupp, men dess låga värms upp efter en kort tidsperiod, vilket orsakar enorm skada och gör den mest effektiv mot mycket hälsosamma trupper. Men i detta läge kan Inferno Tower överväldigas av stora grupper av svagare enheter, som Archers. I multi-target-läge orsakar Inferno Tower konstant skada på flera mål samtidigt. Detta gör den idealisk mot svärmar av svaga trupper men är mycket mindre effektiv på trupper med högre hälsa. I likhet med X-Bow måste Inferno Tower laddas om med jämna mellanrum. Detta görs gratis automatiskt när spelaren loggar in. Men om Inferno Tower fortsätter att avfyra sin ammunition utan att laddas om, kommer det så småningom att ta slut på ammunition och inte attackera. Det tar 2 minuter och 8 sekunder för ett Inferno Tower att lossa all sin ammunition. Inferno Tower har inget favoritmål och inte heller skadar det någon speciell trupp. Men i singelmålsläge ger den mer skada i genomsnitt till trupper med högre träffpunkter, på grund av dess progressiva DPS."
eagleArtillery = "Örnartelleriet är ett mycket kraftfullt försvar som har en räckvidd som täcker nästan hela kartan men har en död fläck som liknar Mortaren. Den är upplåst på Town Hall level 11. Precis som X-Bow, Inferno Tower och Scattershot måste den laddas för att fungera. Laddningen är gratis och sker automatiskt efter att spelaren loggat in; Eagle Artillery kommer så småningom att tömmas på ammunition och lossas om det inte laddas av spelaren. Det tar 5 minuter för ett Eagle Artillery att lossa all sin ammunition. Under ett försvar förblir Eagle Artillery vilande vid starten och aktiveras först efter att ett stort antal bostäder värda trupper har utplacerats. Eagle Artillery kommer att tända ögonen till en början efter 150 platser värda trupper och kommer att aktiveras vid 200 platser värda trupper."
scatterShot = "Scatterskutaren är ett stänkskadeförsvar som har mycket hög skada per sekund. Det är upplåst när du uppgraderar ditt rådhus till nivå 13. Scatterskutaren måste laddas för att fungera. Precis som med andra försvar som behöver laddas om är laddningen gratis och sker automatiskt när användaren loggar in i spelet. Om Scatterskutaren skjuter för många skott utan att laddas om kommer den att ta slut på ammunition och sluta fungera. Det tar 4 minuter och 33 sekunder för en Scatterskutaren att lossa all ammunition."
spellTower = "Trollformeltornet är en försvarsbyggnad upplåst på Stadshusnivå 15. Till skillnad från de konventionella försvarsstrukturerna skjuter Trollformeltornet inte projektiler mot fiender; istället aktiverar den en besvärjelse - liknande den som spelare använder för brott - i dess omgivande radie. Trollformelstornet kan laddas med en av tre trollformler, som har olika effekter på både försvar och attackerande trupper: När trollformelstornet ursprungligen är konstruerat kan det bara laddas med argtrollformler. När en attackerande enhet kommer inom räckhåll för tornet i det här läget kommer Trollformeltornet att starta en arghetstrollformel mot sig själv, vilket ökar skadan på försvar och försvarsenheter inom dess radie. Rörelsehastigheten för försvarande enheter ökas också. När du uppgraderar till nivå 2 kan Trollformeltornet ställas in för att starta gifttrollformler. När en attackerande enhet kommer inom räckhåll för tornet i detta läge, kommer Trollformeltornet att skjuta upp en giftbomb mot enheten, vilket skapar ett område som gör måttlig skada över tiden och som saktar ner attackerande trupper. När du uppgraderar till nivå 3 kan Trollformeltornet ställas in för att starta osynlighetstrollformler. När en byggnad i dess räckvidd attackeras av attackerande enheter, kommer Trollformeltornet att starta en osynlighetstrollformel på sig själv, vilket gör attackerande enheter, försvarsenheter och byggnader i dess räckvidd osynliga."
monolith = "Monoliten är ett försvar som är upplåst på Town Hall nivå 15. Det är ett enmålsförsvar som skjuter mystiska energibollar mot fiender, ger stor skada per skott förutom att hantera en bråkdel av enhetens maximala hälsa med varje skott, vilket gör det förödande mot fiender med hög hälsa. Unikt bland defensiva byggnader är det byggt och uppgraderat med Dark Elixir istället för Guld."
townHall12 = "Stadshuset nivå 12 är det enda rådhuset som har en av dessa Giga Teslas. En nivå 1 Giga Tesla är redan inbyggd i stadshuset när uppgraderingen av stadshusets nivå 12 är klar. Giga Tesla ger mycket hög skada per sekund på flera mål samtidigt. Det dyker bara upp när stadshuset är skadat (antingen av trupp eller av besvärjelser), eller när 51 % av basen är förstörd. Innan Giga Tesla dyker upp behandlas inte stadshuset som en försvarsbyggnad i strid, och försvarsinriktade trupper som Giants kommer inte att attackera det medan andra försvar finns kvar. När Giga Tesla är aktiv kommer dessa trupper att kunna rikta in sig på rådhuset vid sidan av det befintliga försvaret. När den uppgraderas till nivå 5, fungerar Giga Tesla, förutom att ta sin normala skada, också som en slags bomb, som exploderar när stadshuset förstörs, liknande hur bombtornet agerar när det förstörs. Nivåerna på Giga Tesla anges med antalet stjärnor som kan ses när man trycker på ett Rådhus 12. Romerska siffror på sidan av Rådhuset visar också nivån på Giga Tesla inuti."
townHall13 = "Giga Inferno är ett defensivt vapen monterat på nivå 13 Town Hall. Det antyds att snarare än ett vapenbyte är det som en direkt uppgradering för Giga Tesla med ett annat utseende, som de flesta försvar när man uppgraderar till nya nivåer. Även om namnet på vapnet och attackeffekten skiljer sig från Giga Tesla, har vapnets grundläggande karaktär inte förändrats."
townhall14 = "Giga Inferno är ett defensivt vapen monterat på nivå 14 Town Hall. Giga Inferno ger mycket stor skada per sekund till flera mål samtidigt. Det dyker bara upp när rådhuset är skadat eller när 51 % av basen är förstörd. När Rådhuset förstörs släpper det lös en giftbomb som fungerar precis som Poison Spell; det ger skada och saktar ner rörelse och attackhastighet till alla enheter runt Rådhuset. Till en början verkar det som att giftbomben helt tycks ersätta den frysande explosionseffekten, men det är mer som en direkt uppgradering till den."
townHall15 = "Giga Inferno är ett defensivt vapen monterat på nivå 15 Town Hall. Giga Inferno ger mycket stor skada per sekund till flera mål samtidigt. Det dyker bara upp när rådhuset är skadat eller när 51 % av basen är förstörd. När Rådhuset förstörs släpper det lös en giftbomb som fungerar precis som Poison Spell; det ger skada och saktar ner rörelse och attackhastighet till alla enheter runt Rådhuset. Den mesta statistiken för nivå 5 Giga Inferno från Town Hall 14 överförs till Town Hall 15:s nivå 1 Giga Inferno: den enda statistiken som förändras är Town Halls träffpunkter. När den uppgraderas får Giga Inferno förbättringar av olika statistik; till DPS, dess skada när den förstörs eller dess radie för dödsskada."
bomb = "Bomber är fällor som förblir dolda tills de aktiveras av en attackerande trupp som rör sig in i deras utlösningsradie som andra fällor. Det är den första fällan som låses upp. När de väl utlösts måste bomberna återupprustas, vilket kan göras gratis och sker automatiskt efter inloggning i spelet. Även om de är den svagaste av alla fällor, kan bomber fortfarande ha en positiv inverkan på effektiviteten av en bys försvar om de placeras på rätt sätt, men bara om de alltid beväpnas igen efter att de utlösts."
springTrap = "​Fjäderfällan studsar fiendens marktrupper från slagfältet och förstör dem effektivt omedelbart, beroende på deras bostadsutrymmesockupation. Varje fjäderfälla kan studsa av ett visst antal trupper till ett värde av bostäder; uppgradering av fjäderfällan ökar dess kapacitet att skjuta upp trupper."
airBomb = "Luftbomben låses upp på Town Hall nivå 5. Det är den första fällan som riktar sig mot flygtrupper. Den utlöses när en flygande trupp kommer i närheten, reser sig sedan upp ur marken och följer den närmaste flygande truppen. Luftbomben exploderar efter att ha kommit i kontakt med den flygande truppen eller - om den är död - platsen för dess död. Trots namnet är det inte en luftburen version av den normala bomben, eftersom luftbomben kan röra sig. Det är extremt effektivt mot stora grupper av Minions och gör en betydande skada på ballonger (särskilt nivå 3 och lägre). Det är mycket mindre effektivt mot högre hälsomål som Dragons. Precis som andra fällor kräver Air Bomb återupprustning efter att den har aktiverats. Att göra det är gratis och sker automatiskt när spelaren loggar in i spelet."
giantBomb = "Jättebomben låses upp på Town Hall level 6. Liksom Bomben exploderar jättebomben när en fiende kommer i närheten. Det är i grunden en mycket kraftfullare (och dyrare) version av Bomb. Detta ger stänkskador till alla fiender inom en radie på 3-4 brickor, beroende på jättebombens nivå. När den väl har aktiverats måste den jättelika bomben beväpnas på nytt för att vara en del av nästa försvar. Att göra det är gratis och sker automatiskt när spelaren loggar in i spelet. Jättebomber kan göra allvarliga skador på trupper med måttlig hälsa, såsom lågnivåjättar eller grisryttare."
seekingAirMine = "Sökande luftmina är en luftfälla med ett mål. Den består av en metallisk bomb fäst vid tre svarta ballonger med vita dödskallar målade på dem. Medan luftbomben anses vara bombens luftmotsvarighet, anses sökande luftminan vara motsvarigheten till Giant Bomb från luften, dock utan stänk med extrema skador. Denna fälla kommer att riktas mot de flesta luftenheter (inklusive healers, belägringsmaskiner och Grand Warden om han är inställd på luftläge). De enda undantagen är undersåtar, lavavalpar och fladdermöss, av vilka ingen kan utlösa Sökande luftmina eller påverkas av den. Liksom alla fällor, när den väl har aktiverats, måste Seeking Air Mine beväpnas på nytt för att vara en del av nästa försvar (med undantag för Clan Wars och i Legend League, där alla fällor är aktiva för varje fiendeattack) . Att göra det är gratis och sker automatiskt när spelaren loggar in i spelet."
skeletonTrap = "Skelettfällan är en fälla, upplåst på Stadshusnivå 8, som förblir dold tills de aktiveras av en attackerande trupp som rör sig in i deras utlösningsradie. När den väl utlösts reser sig kistan från marken och flera skelett dyker upp i området runt kistan för att attackera närliggande trupper beroende på om den är inställd för mark- eller lufttrupper. När den väl har aktiverats måste skelettfällan beväpnas på nytt för att vara en del av nästa försvar. Att göra det är gratis och sker automatiskt när spelaren loggar in i spelet. De kan konfigureras för att attackera antingen marktrupper eller lufttrupper, men inte båda samtidigt. De kommer att förbli osynliga om de sätts på marken och en lufttrupp passerar (eller tvärtom)."
tornadoTrap = "Virvelvindfällan är den sista fällan som låses upp, den låses upp på Stadshusnivå 11. När den utlöses suger den in attackerande trupper, tvingar dem att flytta och gör småskador på dem. Dess effekt beror på bostadsutrymmet för de drabbade trupperna; mindre trupper kommer att drabbas hårdare än större. Alla attackerande enheter utom Miners, Diggy och Battle Drill kommer att påverkas om den går in i fällans radie."

troop_info_list = [barbarian,archer,giant,goblin,wallBreaker,balloon,wizard,healer,dragon,pekka,babyDragon,miner,electroDragon,yeti,dragonRider,electroTitan,minion,hogRider,valkyrie,golem,witch,lavaHound,bowler,iceGolem,headhunter,superBarbarian,superArcher,sneakyGoblin,superWallBreaker,superGiant,rocketBalloon,superWizard,superDragon,infernoDragon,superMinion,superValkyrie,superWitch,iceHound,superBowler,superMiner,lightningSpell,healingSpell,rageSpell,jumpSpell,freezeSpell,cloneSpell,invisibilitySpell,recallSpell,poisonSpell,earthquakeSpell,hasteSpell,skeletonSpell,batSpell,cannon,archerTower,wall,mortar,airDefence,wizardTower,airSweeper,hiddenTesla,bombTower,Xbow,infernoTower,eagleArtillery,scatterShot,spellTower,monolith,townHall12,townHall13,townhall14,townHall15,bomb,springTrap,airBomb,giantBomb,seekingAirMine,skeletonTrap,tornadoTrap];
